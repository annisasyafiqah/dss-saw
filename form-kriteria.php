...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="form-kriteria.php">
          <i class="bi bi-file-earmark-person"></i>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Form Tambah Data Kriteria</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="vh-50">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="proses-tambah-kriteria.php" method="POST" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Nama Kriteria</label>
                  <input type="text" class="form-control" name="nm_kriteria" id="inputNanme4">
                </div>
