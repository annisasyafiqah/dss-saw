    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Form Tambah Data Alternatif</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section d-flex align-items-center justify-content-between">
      <div class="row">
        <div class="vh-50">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Data Siswa Sebagai Alternatif</h5>
    <?php  
    $id_alternatif = $_GET['id_alternatif'];
    include "koneksi.php";
    $a = "SELECT * FROM alternatif WHERE id_alternatif = '$id_alternatif' ";
    $b=$koneksi->query($a);
    while (($c=$b->fetch_array())) { 
           
        	?>
              <!-- Vertical Form -->
              <form class="row g-3" action="proses-alternatif.php" method="POST" >
              <input type="hidden"  value="ubah" class="form-control" name="aksi" id="inputNanme4">

                <div class="col-12">
                  <label for="inputNanme4" class="form-label">ID Alternatif</label>
                  <input type="text" disabled  value="<?php echo $c['id_alternatif'] ?>" class="form-control" name="id_alternatif" id="inputNanme4">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Nama Alternatif</label>
                  <input type="text" value="<?php echo $c['nm_alternatif'] ?>" class="form-control" name="nm_alternatif" id="inputNanme4">
                </div>
