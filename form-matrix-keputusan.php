...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="form-matrix-keputusan.php">
          <i class="bi bi-file-earmark-person"></i>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Tambah Data Matrix Keputusan </h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Form Tambah Data Matrix Keputusan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="vh-50">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="proses-tambah-matrix-keputusan.php" method="POST" >
              <div class="row g-2">
                ...
                <div class="row g-2">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" name="id_bobot" aria-label="Default select example">
                      <option selected>Pilih Kriteria</option>
                      <?php 
                        include "koneksi.php";
                        $a = "SELECT * FROM kriteria INNER JOIN bobot ON kriteria.id_kriteria = bobot.id_kriteria";
                        $b=$koneksi->query($a);
                        while (($c=$b->fetch_array())) { ?>
                        <tr>
                            <option value="<?php echo $c['id_bobot']; ?>"><?php echo $c['nm_kriteria']; ?></option>
                        </tr>
                     <?php
                        }
                    ?>
                ...
                <div class="row g-2">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" name="id_skala" aria-label="Default select example">
                      ...
                      <?php 
                        ...
                        while (($c=$b->fetch_array())) { ?>
                        <tr>
                            <option value="<?php echo $c['id_skala']; ?>"><?php echo $c['nilai']; ?> &nbsp <?php echo $c['keterangan']; ?></option>
                        </tr>
                     <?php
                        }
                    ?>
...
SELECT * FROM kriteria INNER JOIN bobot ON kriteria.id_kriteria = bobot.id_kriteria