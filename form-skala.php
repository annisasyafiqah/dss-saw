...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="form-skala.php">
          <i class="bi bi-file-earmark-person"></i>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Form Tambah Skala</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="vh-50">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="proses-tambah-skala.php" method="POST" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Nilai</label>
                  <input type="text" class="form-control" name="nilai" id="inputNanme4">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Keterangan</label>
                  <input type="text" class="form-control" name="keterangan" id="inputNanme4">
                </div>
