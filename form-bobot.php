...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="form-bobot.php">
          <i class="bi bi-file-earmark-person"></i>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Form Tambah Data Bobot</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="vh-50">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="proses-tambah-bobot.php" method="POST" >
              <div class="row g-2">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" name="id_kriteria" aria-label="Default select example">
                      ...
                      <?php 
                        ...
                        <tr>
                            <option value="<?php echo $c['id_kriteria']; ?>"><?php echo $c['nm_kriteria']; ?></option>
                        </tr>
                     <?php
                        }
                    ?>
                ...
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Value Bobot</label>
                  <input type="text" class="form-control" name="value_bobot" id="inputNanme4">
                </div>
