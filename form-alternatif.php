...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="form-alternatif.php">
          <i class="bi bi-file-earmark-person"></i>
        ...
        <div class="vh-50">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="proses-tambah-alternatif.php" method="POST" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Nama Siswa</label>
                  <input type="text" class="form-control" name="nm_alternatif" id="inputNanme4">
                </div>
